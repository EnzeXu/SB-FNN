...
class Config(ConfigTemplate):
    def __init__(self):
        ...
        self.model_name = "REP3_Fourier"
        self.curve_names = ["p_cI", "p_lacI", "p_tetR"]
        self.params = Parameters
        self.args = TrainArgs

        self.T = 5#10#15#20#5
        self.T_N_all = 5500#11000#16500#22000#5500
        self.T_N_train = 5000#10000#15000#20000#5000
        self.T_N_test = 500#1000#1500#2000#500
...
def penalty_func(x):
    return 0.5 * (- torch.tanh((x - 0.08) * 250) + 1)
